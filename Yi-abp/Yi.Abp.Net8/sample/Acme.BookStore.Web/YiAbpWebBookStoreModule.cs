...
{
    [DependsOn(
        typeof(YiAcmeBookStoreAbpSqlSugarCoreModule),
        typeof(YiAcmeBookStoreAbpApplicationModule),
    ...
    public class YiAbpWebBookStoreModule : AbpModule
    {
        ...
        public override Task ConfigureServicesAsync(ServiceConfigurationContext context)
        {
            ...
            {
                options.ConventionalControllers.Create(typeof(YiAcmeBookStoreAbpApplicationModule).Assembly, options => options.RemoteServiceName = "default");
            ...
            //Swagger
            context.Services.AddYiSwaggerGen<YiAbpWebBookStoreModule>(options =>
            {
