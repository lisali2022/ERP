...
namespace Yi.Framework.SqlSugarCore
{
    public class SqlSugarDbContext : ISqlSugarDbContext
    {
        ...
        public SqlSugarDbContext(IAbpLazyServiceProvider lazyServiceProvider)
        {
            ...
            connectionCreator.SetDbAop(SqlSugarClient); //统一使用aop处理           
            SqlSugarClient.CurrentConnectionConfig.ConfigureExternalServices.SerializeService = SerializeService; //替换默认序列化器
        }
