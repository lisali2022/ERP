...
using JM.SqlServer.Application;
...
namespace Yi.Abp.Web
{
    [DependsOn(
        ...
        typeof(Application.YiAbpApplicationModule),
    ...
    public class YiAbpWebModule : AbpModule
    {
        ...
        public override Task ConfigureServicesAsync(ServiceConfigurationContext context)
        {
            ...
            //全局配置Json序列化处理
            service.AddMvc().AddNewtonsoftJson(options =>
            {              
            ...
            {
                options.ConventionalControllers.Create(typeof(Application.YiAbpApplicationModule).Assembly,
                ...
                options.ConventionalControllers.Create(typeof(JMSqlServerApplicationModule).Assembly,
                    options => options.RemoteServiceName = "jm-sqlserver");
                options.ConventionalControllers.Create(typeof(YiAcmeBookStoreAbpApplicationModule).Assembly,
                    options => options.RemoteServiceName = "acme-bookstore");
