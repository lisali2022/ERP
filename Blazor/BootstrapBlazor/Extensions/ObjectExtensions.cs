...
public static class ObjectExtensions
{
    ...
    /// </summary>
    /// <returns></returns>
    public static bool TryConvertTo(this string? source, Type type, [System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)]out object? val)
    {
        var ret = true;
        val = source;
    ...
    /// <param name="val"></param>
    /// <returns></returns>
    public static bool TryConvertTo<TValue>(this string? source, [System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)]out TValue val)
    {
        var ret = false;
