...
public static class IEditItemExtensions
{
    ...
    internal static Microsoft.AspNetCore.Components.RenderFragment RenderValue<TItem>(this ITableColumn col, TItem item) => async builder =>
    {
    ...
    private static Microsoft.AspNetCore.Components.RenderFragment RenderSwitch(this bool value) => builder =>
    {
        // 自动化处理 bool 值
    ...
    internal static Microsoft.AspNetCore.Components.RenderFragment RenderColor<TItem>(this ITableColumn col, TItem item) => builder =>
    {
        var val = col.GetItemValue(item);
    ...
    private static Microsoft.AspNetCore.Components.RenderFragment RenderTooltip(this ITableColumn col, string? text) => pb =>
    {
        if (col.ShowTips)
        {
            ...
            {
                pb.AddAttribute(3, nameof(Tooltip.ChildContent), new Microsoft.AspNetCore.Components.RenderFragment(builder => builder.AddMarkupContent(0, text)));
                pb.AddAttribute(4, nameof(Tooltip.IsHtml), true);
            }
            else
            {
                pb.AddAttribute(3, nameof(Tooltip.ChildContent), new Microsoft.AspNetCore.Components.RenderFragment(builder => builder.AddContent(0, text)));
            }
            pb.CloseComponent();
        }
