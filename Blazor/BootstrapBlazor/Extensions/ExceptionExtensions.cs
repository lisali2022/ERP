...
public static class ExceptionExtensions
{
    ...
    /// <param name="collection"></param>
    /// <returns></returns>
    public static Microsoft.AspNetCore.Components.MarkupString FormatMarkupString(this Exception exception, NameValueCollection? collection = null)
    {
        var message = Format(exception, collection);
        return new Microsoft.AspNetCore.Components.MarkupString(message.Replace(Environment.NewLine, "<br />"));
    }
}
