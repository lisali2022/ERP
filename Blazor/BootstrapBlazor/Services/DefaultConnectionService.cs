...
class DefaultConnectionService : IConnectionService, IDisposable
{
    ...
    /// <returns></returns>
    public bool TryGetValue(string key, [System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)]out ConnectionItem? value) => _connectionCache.TryGetValue(key, out value);
