...
internal class CacheManager : ICacheManager
{
    ...
    /// <returns></returns>
    public bool TryGetValue<TItem>(object key, [System.Diagnostics.CodeAnalysis.NotNullWhen(true)]out TItem? value)
    {
    ...
    public static RangeAttribute? GetRange(Type modelType, string fieldName)
    {
        ...
        return Instance.GetOrCreate(cacheKey, entry =>
        {
            System.ComponentModel.DataAnnotations.RangeAttribute? dn = null;
    ...
    public static bool TryGetProperty(Type modelType, string fieldName, [System.Diagnostics.CodeAnalysis.NotNullWhen(true)]out PropertyInfo? propertyInfo)
    {
