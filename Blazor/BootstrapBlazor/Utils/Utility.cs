...
public static class Utility
{
    ...
    /// <returns></returns>
    public static bool TryGetProperty(Type modelType, string fieldName, [System.Diagnostics.CodeAnalysis.NotNullWhen(true)]out PropertyInfo? propertyInfo) => CacheManager.TryGetProperty(modelType, fieldName, out propertyInfo);
    ...
    /// <param name="fieldType"></param>
    /// <returns></returns>
    public static object GenerateValueChanged(Microsoft.AspNetCore.Components.ComponentBase component, object model, string fieldName, Type fieldType)
    {
        ...
        {
            var exp_p1 = Expression.Parameter(typeof(Microsoft.AspNetCore.Components.ComponentBase));
    ...
    /// <param name="fieldName"></param>
    /// <returns></returns>
    public static Microsoft.AspNetCore.Components.EventCallback<TType> CreateCallback<TType>(Microsoft.AspNetCore.Components.ComponentBase component, object model, string fieldName) => Microsoft.AspNetCore.Components.EventCallback.Factory.Create<TType>(component, t => CacheManager.SetPropertyValue(model, fieldName, t));
