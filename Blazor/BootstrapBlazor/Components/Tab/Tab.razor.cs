...
public partial class Tab : IHandlerException
{
  ...
  public Microsoft.AspNetCore.Components.RenderFragment? ButtonTemplate { get; set; }
    ...
    private IStringLocalizer<Tab>? Localizer { get; set; }
     ...
     [Microsoft.AspNetCore.Components.Inject]
    [System.Diagnostics.CodeAnalysis.NotNull]
    private Microsoft.AspNetCore.Components.NavigationManager? Navigator { get; set; }
    ...
    private void AddTabItem(string url)
    {
        ...
        if (context.Handler != null)
        {
            ...
            parameters.Add(nameof(TabItem.ChildContent), new Microsoft.AspNetCore.Components.RenderFragment(builder =>
            {
    ...
    private Microsoft.AspNetCore.Components.RenderFragment RenderTabItemContent(TabItem item) => builder =>
    {
        if (item.IsActive)
        {
    ...
    private Microsoft.AspNetCore.Components.RenderFragment? _errorContent;
