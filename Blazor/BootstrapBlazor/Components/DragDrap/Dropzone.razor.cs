...
public partial class Dropzone<TItem> : IDisposable
{
  ...
  public Microsoft.AspNetCore.Components.RenderFragment<TItem>? ChildContent { get; set; }
    ...
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
    public Microsoft.AspNetCore.Components.EventCallback<TItem> OnItemDropRejectedByMaxItemLimit { get; set; }

    /// <summary>
    /// 获得/设置 当拖拽被禁止时调用
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
    public Microsoft.AspNetCore.Components.EventCallback<TItem> OnItemDropRejected { get; set; }

    /// <summary>
    /// 获得/设置 返回被替换的 Item
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
    public Microsoft.AspNetCore.Components.EventCallback<TItem> OnReplacedItemDrop { get; set; }

    /// <summary>
    /// 获得/设置 返回放下的 Item
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
    public Microsoft.AspNetCore.Components.EventCallback<TItem> OnItemDrop { get; set; }
