...
public partial class EditorForm<TModel> : IShowLabel
{
    ...
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
  public Microsoft.AspNetCore.Components.RenderFragment<TModel>? FieldItems { get; set; }

    /// <summary>
    /// 获得/设置 按钮模板
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
  public Microsoft.AspNetCore.Components.RenderFragment? Buttons { get; set; }
    ...
    [Microsoft.AspNetCore.Components.CascadingParameter(Name = "IsSearch")]
    [System.Diagnostics.CodeAnalysis.NotNull]
    ...
    private Microsoft.AspNetCore.Components.RenderFragment AutoGenerateTemplate(IEditorItem item) => builder =>
    {
    ...
    private Microsoft.AspNetCore.Components.RenderFragment<object>? GetRenderTemplate(IEditorItem item) => IsSearch.Value && item is ITableColumn col
        ? col.SearchTemplate
        : item.EditTemplate;
}
