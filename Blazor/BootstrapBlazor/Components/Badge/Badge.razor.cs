...
public partial class Badge
{
    ...
    /// 获得/设置 颜色
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter] public Color Color { get; set; } = Color.Primary;

    /// <summary>
    /// 获得/设置 是否显示为胶囊形式
    /// </summary>
    /// <value></value>
    [Microsoft.AspNetCore.Components.Parameter] public bool IsPill { get; set; }
