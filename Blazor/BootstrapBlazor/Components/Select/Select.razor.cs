...
public partial class Select<TValue> : ISelect
{
    ...
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
  public Microsoft.AspNetCore.Components.RenderFragment? Options { get; set; }

    /// <summary>
    /// 获得/设置 显示部分模板 默认 null
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
  public Microsoft.AspNetCore.Components.RenderFragment<SelectedItem?>? DisplayTemplate { get; set; }
    ...
    /// <returns></returns>
    protected override bool TryParseValueFromString(string value, [System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)]out TValue result, out string? validationErrorMessage) => ValueType == typeof(SelectedItem)
    ...
    private bool TryParseSelectItem(string value, [System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)]out TValue result, out string? validationErrorMessage)
    {
