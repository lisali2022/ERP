...
public class DynamicElement : BootstrapComponentBase
{
  ...
  public Microsoft.AspNetCore.Components.RenderFragment? ChildContent { get; set; }
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        if (IsTriggerClick())
        {
            builder.AddAttribute(2, "onclick", Microsoft.AspNetCore.Components.EventCallback.Factory.Create<MouseEventArgs>(this, e => OnClick!()));
        }

        if (IsTriggerDoubleClick())
        {
            builder.AddAttribute(3, "ondblclick", Microsoft.AspNetCore.Components.EventCallback.Factory.Create<MouseEventArgs>(this, e => OnDoubleClick!()));
        }
        ...
        {
            builder.AddAttribute(6, "oncontextmenu", Microsoft.AspNetCore.Components.EventCallback.Factory.Create<MouseEventArgs>(this, e => OnContextMenu(e)));
