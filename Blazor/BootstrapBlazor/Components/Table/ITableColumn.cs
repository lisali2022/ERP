...
public interface ITableColumn : IEditorItem
{
    ...
    /// 获得/设置 显示模板
    /// </summary>
    Microsoft.AspNetCore.Components.RenderFragment<object>? Template { get; set; }

    /// <summary>
    /// 获得/设置 搜索模板
    /// </summary>
    Microsoft.AspNetCore.Components.RenderFragment<object>? SearchTemplate { get; set; }

    /// <summary>
    /// 获得/设置 过滤模板
    /// </summary>
    Microsoft.AspNetCore.Components.RenderFragment? FilterTemplate { get; set; }

    /// <summary>
    /// 获得/设置 表头模板
    /// </summary>
    Microsoft.AspNetCore.Components.RenderFragment<ITableColumn>? HeaderTemplate { get; set; }
