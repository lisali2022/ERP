    ...
    private async Task ShowSortDialog()
    {
        var result = await DialogService.ShowModal<TableAdvancedSortDialog>(new ResultDialogOption
        {
            ...
            ComponentParameters = new Dictionary<string, object>
            {
                ...
                [nameof(TableAdvancedSortDialog.ValueChanged)] = Microsoft.AspNetCore.Components.EventCallback.Factory.Create<List<TableSortItem>>(this, v => AdvancedSortItems = v),
