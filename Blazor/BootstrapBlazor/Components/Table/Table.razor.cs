...
[Microsoft.AspNetCore.Components.CascadingTypeParameter(nameof(TItem))]
#endif
public partial class Table<TItem> : ITable, IModelEqualityComparer<TItem> where TItem : class, new()
{
    ...
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
  public Microsoft.AspNetCore.Components.RenderFragment? MultiHeaderTemplate { get; set; }
    ...
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
  public Microsoft.AspNetCore.Components.RenderFragment<TItem>? DetailRowTemplate { get; set; }

    /// <summary>
    /// 获得/设置 TableHeader 实例
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
  public Microsoft.AspNetCore.Components.RenderFragment<TItem>? TableColumns { get; set; }

    /// <summary>
    /// 获得/设置 TableFooter 实例
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
  public Microsoft.AspNetCore.Components.RenderFragment<IEnumerable<TItem>>? TableFooter { get; set; }

    /// <summary>
    /// 获得/设置 Table Footer 模板
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
  public Microsoft.AspNetCore.Components.RenderFragment<IEnumerable<TItem>>? FooterTemplate { get; set; }
    ...
    /// </summary>
    [Microsoft.AspNetCore.Components.Parameter]
    public Microsoft.AspNetCore.Components.EventCallback<IEnumerable<TItem>> ItemsChanged { get; set; }
  ...
  public Microsoft.AspNetCore.Components.RenderFragment? EmptyTemplate { get; set; }
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    protected Microsoft.AspNetCore.Components.RenderFragment GetValue(ITableColumn col, TItem item) => builder =>
    {
    ...
    /// <returns></returns>
    protected Microsoft.AspNetCore.Components.RenderFragment RenderCell(ITableColumn col, TItem item, ItemChangedType changedType)
    {
        return col.CanWrite(typeof(TItem), changedType) ? RenderEditTemplate() : RenderTemplate();

        Microsoft.AspNetCore.Components.RenderFragment RenderTemplate() => col.Template == null
            ? new Microsoft.AspNetCore.Components.RenderFragment(builder => builder.CreateDisplayByFieldType(col, item))
            : col.Template(item);

        Microsoft.AspNetCore.Components.RenderFragment RenderEditTemplate() => col.EditTemplate == null
            ? new Microsoft.AspNetCore.Components.RenderFragment(builder => builder.CreateComponentByFieldType(this, col, item, changedType, false, LookupService))
    ...
    /// <param name="changedType"></param>
    /// <returns></returns>
    protected Microsoft.AspNetCore.Components.RenderFragment RenderExcelCell(ITableColumn col, TItem item, ItemChangedType changedType)
    {
        col.PlaceHolder ??= "";
        col.IsPopover = true;
